...
//                     // [최소화 코드] 키오스크 단말로부터 전송된 메시지를 즉시 알림창으로 띄움
//                     this.Invoke(new Action(() => {
//                         MessageBox.Show($"[수신 메시지]:\n{jsonMessage}", "키오스크 수신 알림", MessageBoxButtons.OK, MessageBoxIcon.Information);
//                     }));
...
//                 if (string.IsNullOrWhiteSpace(콜))
